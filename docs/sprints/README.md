...
| 3.2 | ⏳ À faire | [Stack classifier & recipes](./sprint-3.2-stack-classifier-recipes.md) | Détection statique multi-signal + Dockerfiles PHP managés (Laravel/Symfony) | Fixtures PHP MakFly déployées via recipe, zéro Dockerfile user |
