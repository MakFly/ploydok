...
function MonitoringPage(): React.JSX.Element {
  ...
  return (
    <ShellPage
      title="Monitoring"
      description="Real-time health of every container the Ploydok platform is supervising. Streams live over SSE and refreshes every five seconds."
...
function Metric({
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1 px-5 py-4">
      ...
      <dd>
        <span className={cn("font-heading text-xl font-medium tabular-nums", accentText === "text-muted-foreground" ? "text-foreground" : accentText)}>
          {value}
        </span>
        {sub ? (
...
function ChipGroup({
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-md border border-border bg-muted/40 p-0.5">
      <span className="flex items-center gap-1 pl-2 pr-1 font-mono text-[9px] tracking-wide text-muted-foreground uppercase">
    ...
    <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border bg-muted/20 px-6 py-16 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="max-w-sm text-xs text-muted-foreground">
          The agent will start reporting containers here as soon as services
