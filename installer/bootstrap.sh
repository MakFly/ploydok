...
#   curl -fsSL https://raw.githubusercontent.com/dev-toolings/ploydok/main/installer/bootstrap.sh | sudo bash -s -- --mode=coexist --yes
#
...
REPO_URL="${PLOYDOK_REPO_URL:-https://github.com/dev-toolings/ploydok.git}"
